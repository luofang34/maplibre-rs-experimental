...
let package = Package(
    ...
    targets: [
        .target(
            ...
            sources: ["MapPlacement.swift", "MapGestureInput.swift", "GlobeDrag.swift", "MapDragPlane.swift", "MapGestureRecognizer.swift", "MapMemoryBudget.swift", "MapZoomStress.swift"]),
